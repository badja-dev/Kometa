...
- Wrap log lines that exceed `screen_width` so bordered (`| … |`) and plain messages no longer overflow the log box; continuation lines are indented with two spaces to visually distinguish them from the first line.
