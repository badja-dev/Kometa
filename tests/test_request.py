...
def make_image_requests():
    """Bare Requests instance with just the attributes get_image() touches, plus its get() cast to MagicMock for mock-attribute access (perf project, 2026-07-10 - same cast pattern test_plex.py uses for this exact pyright gotcha)."""
    req = make_requests()
