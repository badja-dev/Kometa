...
# ═══════════════════════════════════════════════════════════════════════
# _resolve_image_path - git:/repo:/url: image caching (perf project, 2026-07-10)
#
# get_and_save_image() used to fetch+overwrite from the network unconditionally on every
# call. See KOMETA-PERFORMANCE-PROFILING-PLAN.md Phase 5 checklist item 5 - real timings
# showed 194 network/github:image calls in one run, with no local-reuse check at all.
# ═══════════════════════════════════════════════════════════════════════
