...
# ═══════════════════════════════════════════════════════════════════════
# _query_map / _update_map in-process memoization (perf project, 2026-07-10)
#
# cache/query_tmdb_to_tvdb_map showed 61,713 calls for a 987-item test library
# in a real profiling run (88.7% hit rate against the on-disk cache, but zero
# in-process memoization) - see KOMETA-PERFORMANCE-PROFILING-PLAN.md Phase 5
# checklist item 3. These tests cover the memoization layer added to
